...
\date{\Large{\textcolor{FedoraBlue}{http://fedoraproject.org}}}
\author{marketing@lists.fedoraproject.org}
...
\maketitle
\thispagestyle{fancy}
% Remove the horizontal line that fancyhdr puts in
\renewcommand{\headrulewidth}{0pt}

 % Clear the header and footer before we add our own
\fancyfoot{}
\fancyhead{}

%% TODO: Move this a little further up
\fancyfoot[C]{\small{Fedora and the Infinity Logo are\\registered trademarks of Red Hat, Inc.}}
